...
--- @param new_opts bauhaus.Config
--- @return bauhaus.Config
function M.set_options(new_opts)
  local opts = vim.g.bauhaus_opts
  vim.g.bauhaus_opts = vim.tbl_deep_extend("force", opts, new_opts)

  return vim.g.bauhaus_opts
end
...
function M.toggle_lualine_theme()
  ...
  package.loaded["lualine.themes.bauhaus"] = nil
  local lualine_opts = require("lualine").get_config()
  local lualine_theme = require("lualine.themes.bauhaus")
